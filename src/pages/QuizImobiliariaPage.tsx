...
type Step = 'intro' | 'quiz' | 'open' | 'capture' | 'result'
...
const questions: Question[] = [
  {
    ...
    options: [
      {
        text: 'Menos de 2 anos — estou migrando ou começando',
        weights: { icp1: 0, icp2: 0, icp3: 1, icp4: 4, icp5: 0, icp6: 0 },
      },
      {
        text: '2 a 10 anos — já tenho carteira mas quero crescer',
        weights: { icp1: 0, icp2: 1, icp3: 3, icp4: 2, icp5: 2, icp6: 0 },
      },
      {
        text: '10 a 20 anos — mercado consolidado na minha região',
        weights: { icp1: 2, icp2: 2, icp3: 1, icp4: 0, icp5: 3, icp6: 2 },
      },
      {
        text: 'Mais de 20 anos — conheço todo mundo no mercado',
        weights: { icp1: 4, icp2: 1, icp3: 0, icp4: 0, icp5: 1, icp6: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: 'Indicações e networking presencial',
        weights: { icp1: 5, icp2: 0, icp3: 1, icp4: 1, icp5: 0, icp6: 1 },
      },
      {
        text: 'Portais imobiliários (ZAP, OLX, VivaReal)',
        weights: { icp1: 0, icp2: 5, icp3: 1, icp4: 0, icp5: 0, icp6: 1 },
      },
      {
        text: 'Instagram / redes sociais orgânicas',
        weights: { icp1: 0, icp2: 0, icp3: 2, icp4: 3, icp5: 1, icp6: 0 },
      },
      {
        text: 'Anúncios pagos (Google ou Instagram)',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 5, icp6: 2 },
      },
      {
        text: 'Não tenho uma fonte principal definida',
        weights: { icp1: 1, icp2: 1, icp3: 2, icp4: 3, icp5: 0, icp6: 0 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: 'Nada — estou começando do zero',
        weights: { icp1: 4, icp2: 0, icp3: 1, icp4: 3, icp5: 0, icp6: 0 },
      },
      {
        text: 'Até R$1.000 (basicamente portais)',
        weights: { icp1: 1, icp2: 4, icp3: 1, icp4: 1, icp5: 0, icp6: 0 },
      },
      {
        text: 'R$1.000 a R$3.000',
        weights: { icp1: 0, icp2: 1, icp3: 2, icp4: 2, icp5: 2, icp6: 1 },
      },
      {
        text: 'R$3.000 a R$5.000',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 4, icp6: 2 },
      },
      {
        text: 'Mais de R$5.000',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 2, icp6: 5 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: 'Nunca — não sei por onde começar',
        weights: { icp1: 3, icp2: 1, icp3: 0, icp4: 4, icp5: 0, icp6: 0 },
      },
      {
        text: 'Já impulsionei posts, mas sem resultado claro',
        weights: { icp1: 0, icp2: 0, icp3: 4, icp4: 2, icp5: 0, icp6: 0 },
      },
      {
        text: 'Já testei por 1-3 meses e parei',
        weights: { icp1: 0, icp2: 0, icp3: 5, icp4: 1, icp5: 0, icp6: 0 },
      },
      {
        text: 'Faço atualmente, mas gerencio sozinho',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 5, icp6: 1 },
      },
      {
        text: 'Faço com agência, mas não estou satisfeito',
        weights: { icp1: 0, icp2: 0, icp3: 1, icp4: 0, icp5: 3, icp6: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: 'Trabalho solo',
        weights: { icp1: 2, icp2: 2, icp3: 2, icp4: 3, icp5: 2, icp6: 0 },
      },
      {
        text: 'Tenho 1-3 corretores comigo',
        weights: { icp1: 1, icp2: 1, icp3: 1, icp4: 1, icp5: 2, icp6: 1 },
      },
      {
        text: 'Gerencio equipe de 4-10 corretores',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 1, icp6: 4 },
      },
      {
        text: 'Imobiliária com mais de 10 corretores',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 0, icp6: 5 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: 'Menos de 5 minutos — tenho processo definido',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 3, icp6: 4 },
      },
      {
        text: 'Até 1 hora',
        weights: { icp1: 0, icp2: 1, icp3: 1, icp4: 1, icp5: 2, icp6: 1 },
      },
      {
        text: 'No mesmo dia, quando dá',
        weights: { icp1: 1, icp2: 2, icp3: 2, icp4: 2, icp5: 0, icp6: 0 },
      },
      {
        text: 'Pode demorar mais de 24h',
        weights: { icp1: 3, icp2: 1, icp3: 1, icp4: 2, icp5: 0, icp6: 0 },
      },
      {
        text: 'Não tenho processo de resposta definido',
        weights: { icp1: 2, icp2: 1, icp3: 2, icp4: 3, icp5: 0, icp6: 0 },
      },
    ],
  },
  {
    ...
    options: [
      {
        text: '"Meu negócio é olho no olho. Não preciso de internet pra vender."',
        weights: { icp1: 6, icp2: 0, icp3: 0, icp4: 0, icp5: 0, icp6: 0 },
      },
      {
        text: '"Já gasto com portal, não quero mais uma despesa."',
        weights: { icp1: 0, icp2: 6, icp3: 0, icp4: 0, icp5: 0, icp6: 0 },
      },
      {
        text: '"Já tentei anúncios e joguei dinheiro fora."',
        weights: { icp1: 0, icp2: 0, icp3: 6, icp4: 0, icp5: 0, icp6: 0 },
      },
      {
        text: '"Sei que preciso de tráfego pago, mas não sei por onde começar."',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 6, icp5: 0, icp6: 0 },
      },
      {
        text: '"Já faço tráfego, mas não estou tirando o máximo."',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 6, icp6: 0 },
      },
      {
        text: '"Preciso de operação profissional com números claros e ROI."',
        weights: { icp1: 0, icp2: 0, icp3: 0, icp4: 0, icp5: 0, icp6: 6 },
      },
    ],
  },
]
...
function buildWppMessage(profileKey: ICPKey, userName: string, openAnswer: string): string {
  ...
  const base: Record<ICPKey, string> = {
    icp1: `Olá, Virtual Mark! 🏛️\n\nMeu nome é ${userName} e fiz o diagnóstico — meu perfil é *${profile.name}*.\n\nTenho anos de mercado imobiliário e trabalho muito com indicações e relacionamento presencial, mas percebi que preciso de presença digital para não perder território.\n\nMeu maior desafio: ${challenge}\n\nGostaria de conversar com um especialista.`,
    icp2: `Olá, Virtual Mark! 🔄\n\nMeu nome é ${userName} e fiz o diagnóstico — meu perfil é *${profile.name}*.\n\nHoje invisto em portais imobiliários, mas pago caro por leads disputados com dezenas de outros corretores ao mesmo tempo.\n\nMeu maior desafio: ${challenge}\n\nQuero entender como ter leads exclusivos com custo menor.`,
    icp3: `Olá, Virtual Mark! 🔥\n\nMeu nome é ${userName} e fiz o diagnóstico — meu perfil é *${profile.name}*.\n\nJá tentei impulsionar posts e rodar anúncios, mas não vi resultado claro. Joguei dinheiro fora e parei.\n\nMeu maior desafio: ${challenge}\n\nQuero entender o que deu errado e como fazer gestão de tráfego de verdade.`,
    icp4: `Olá, Virtual Mark! 🚀\n\nMeu nome é ${userName} e fiz o diagnóstico — meu perfil é *${profile.name}*.\n\nSei que o marketing digital é o caminho, mas ainda não dei o primeiro passo porque não sei como começar sem perder dinheiro.\n\nMeu maior desafio: ${challenge}\n\nQuero um plano de lançamento com investimento mínimo.`,
    icp5: `Olá, Virtual Mark! 📈\n\nMeu nome é ${userName} e fiz o diagnóstico — meu perfil é *${profile.name}*.\n\nJá faço tráfego pago e gero leads, mas gerencio tudo sozinho e sei que poderia estar otimizando muito mais.\n\nMeu maior desafio: ${challenge}\n\nQuero uma auditoria gratuita das minhas campanhas.`,
    icp6: `Olá, Virtual Mark! 🏢\n\nMeu nome é ${userName} e fiz o diagnóstico — meu perfil é *${profile.name}*.\n\nTenho equipe de corretores e preciso alimentar todos com leads qualificados mensalmente. Preciso de operação profissional.\n\nMeu maior desafio: ${challenge}\n\nGostaria de receber uma proposta personalizada.`,
  }
  ...
  return (
    ...
    >
      ...
      >
        <Link
          to="/imobiliarias"
          style={{ textDecoration: 'none', fontSize: 20, fontWeight: 800, color: '#f1f5f9' }}
        >
      ...
      {step === 'intro' && (
        ...
        >
          ...
          <p style={{ fontSize: 16, color: '#94a3b8', lineHeight: 1.7, margin: '0 0 12px' }}>
            Responda 8 perguntas e receba um{' '}
            <strong style={{ color: '#e2e8f0' }}>diagnóstico personalizado</strong> para o seu
            perfil — com os gargalos específicos que estão travando seu crescimento.
          </p>

          <p style={{ fontSize: 14, color: '#64748b', margin: '0 0 32px' }}>
            Não é um quiz genérico. Identificamos{' '}
            <strong style={{ color: '#94a3b8' }}>6 perfis diferentes</strong> de corretores e
            entregamos recomendações cirúrgicas para cada um.
          </p>
      ...
      {(step === 'quiz' || step === 'open' || step === 'capture') && (
        <div style={{ maxWidth: 560, width: '100%' }}>
          ...
          {step === 'quiz' && current < questions.length && (
            <div
              key={current}
              style={{ animation: fading ? 'fadeOut .28s ease' : 'fadeUp .4s ease-out' }}
            >
              <div
                style={{
                  fontSize: 12,
                  ...
                  >
                    <span
                      style={{
                        ...
                        justifyContent: 'center',
                        background:
                          selected === i ? '#ef4444' : 'rgba(255,255,255,0.08)',
                        fontSize: 12,
                        fontWeight: 800,
                        color: selected === i ? '#fff' : '#64748b',
                      }}
                    >
          ...
          {step === 'open' && (
            <div style={{ animation: 'fadeUp .4s ease-out' }}>
              ...
              <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 20px' }}>
                Seja específico — isso personaliza seu plano de ação e a mensagem para nosso
                especialista.
              </p>
              <textarea
                value={openAnswer}
          ...
          {step === 'capture' && (
            <div style={{ animation: 'fadeUp .4s ease-out' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {[
                  { ph: 'Seu nome completo', val: name, set: setName, type: 'text' },
                ...
                <button
                  onClick={() => {
                    if (name.trim() && email.trim() && phone.trim()) setStep('result')
                  }}
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    cursor:
                      name.trim() && email.trim() && phone.trim() ? 'pointer' : 'not-allowed',
                    background:
                      name.trim() && email.trim() && phone.trim()
                        ? 'linear-gradient(135deg, #dc2626, #ef4444)'
                        : 'rgba(255,255,255,0.08)',
                    color:
                      name.trim() && email.trim() && phone.trim() ? '#fff' : '#475569',
                    transition: 'all 0.2s',
                  }}
                >
      ...
      {step === 'result' && profile && result && (
        ...
        >
          ...
          >
            ...
            {ICP_KEYS.map((k) => (
              <StatBar
                ...
                value={result.totals[k]}
                maxVal={result.max}
                color={result.key === k ? profile.color : '#334155'}
              />
            ))}
          </div>
          ...
          >
            ...
            <a
              href={`https://wa.me/${WPP_NUMBER}?text=${buildWppMessage(result.key, name, openAnswer)}`}
              target="_blank"
          ...
          <div style={{ textAlign: 'center', marginTop: 32, padding: '16px 0' }}>
            <Link
              to="/imobiliarias"
              style={{ textDecoration: 'none', fontSize: 13, color: '#334155', fontWeight: 600, letterSpacing: '2px' }}
            >
